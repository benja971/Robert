...
// Show app header
{
	...
	const package_name = pakage.name.replace(/^./, str => str.toUpperCase());
	...
	console.log(`${colors.blue}${package_name}${colors.white} version ${colors.yellow}${pakage.version}${colors.white}`);
...
// eslint-disable-next-line no-lone-blocks
{
	...
	app.use(async (req, res, next) => {
		...
		if (parseInt(process.env.LOG_CONNECTIONS) === 1 && signifiant) {
